...
#define MBEDTLS_OID_EDDSA_25519				"\x2b" "\x65" "\x70"
...
// OID Bytes: 06 0B - 60 86 48 01 86 FA 6B 50 08 01 0A
#define MBEDTLS_OID_ED25519_MLDSA65 		"\x60" "\x86" "\x48" "\x01" "\x86" "\xFA" "\x6B" "\x50" "\x08" "\x01" "\x0a" //60 86 48 01 86 FA 6B 50 08 01 0A
/*
