...
#endif /* MBEDTLS_RSA_C */
    {
        OID_DESCRIPTOR(MBEDTLS_OID_EDDSA_25519,     "eddsa-25519",    "EDDSA-25519"),
		MBEDTLS_MD_EDDSA /*MBEDTLS_MD_SHA512*/,   MBEDTLS_PK_EDDSA,
    },

	{
		OID_DESCRIPTOR(MBEDTLS_OID_ED25519_MLDSA65,     "ed25519-mldsa65",    "ED25519-MLDSA65"),
		MBEDTLS_MD_EDDSA, MBEDTLS_PK_ED25519_MLDSA65,
	},
	{
        OID_DESCRIPTOR(MBEDTLS_OID_ED25519_MLDSA44,     "ed25519-mldsa644",    "ED25519-MLDSA44"),
        MBEDTLS_MD_EDDSA, MBEDTLS_PK_ED25519_MLDSA44,
	},
    {
        NULL_OID_DESCRIPTOR,
...
static const oid_pk_alg_t oid_pk_alg[] =
{
	...
	{
		OID_DESCRIPTOR(MBEDTLS_OID_EDDSA_25519, "id-edKey", "EC key for EDDSA"),
		MBEDTLS_PK_EDDSA, //PROBABILMENTE DOBBIAMO USARE MBEDTLS_PK_EDDSA PERO VOGLIO TESTARE CHE SUCCEDE
	},
	{
			OID_DESCRIPTOR(MBEDTLS_OID_ED25519_MLDSA65,     "ed25519-mldsa65",    "ED25519-MLDSA65"),
			MBEDTLS_PK_ED25519_MLDSA65
	},
	{
			OID_DESCRIPTOR(MBEDTLS_OID_ED25519_MLDSA44,     "ed25519-mldsa44",    "ED25519-MLDSA44"),
			MBEDTLS_PK_ED25519_MLDSA44
	},
    {
        NULL_OID_DESCRIPTOR,
        MBEDTLS_PK_NONE,
...
static const oid_pk_alg_t *oid_pk_alg_from_asn1(                   \
        const mbedtls_asn1_buf *oid)     \
    {                                                                   \
...
/*FN_OID_GET_ATTR1(mbedtls_oid_get_ec_grp_algid,
                 ...
                 mbedtls_ecp_group_id,
                 grp_id)*/
static const oid_ecp_grp_algid_t *oid_grp_id_algid_from_asn1(                   \
        const mbedtls_asn1_buf *oid)     \
    {                                                                   \
        const oid_ecp_grp_algid_t *p = (oid_ecp_grp_algid);                                       \
        const mbedtls_oid_descriptor_t *cur =                           \
            (const mbedtls_oid_descriptor_t *) p;                       \
        if (p == ((void *)0) || oid == ((void *)0)) return ((void *)0);                  \
        while (cur->asn1 != ((void *)0)) {                                    \
...
int mbedtls_oid_get_ec_grp_algid(const mbedtls_asn1_buf *oid, mbedtls_ecp_group_id * grp_id)                  \
    {                                                                       \
        const oid_ecp_grp_algid_t *data = oid_grp_id_algid_from_asn1(oid);        \
        if (data == ((void *)0)) return -0x002E;            \
        *grp_id = data->grp_id;                                               \
        return 0;                                                        \
    }
