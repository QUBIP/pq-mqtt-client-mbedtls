                                              ...
                                              size_t verify_buffer_len)
{
    ...
    if(md_alg == MBEDTLS_MD_EDDSA){
    		...
    		verify_hash_size = verify_buffer_len;
        } else {
        	verify_hash = malloc(MBEDTLS_MD_MAX_SIZE);
        	verify_hash_size = MBEDTLS_MD_MAX_SIZE;
    }
