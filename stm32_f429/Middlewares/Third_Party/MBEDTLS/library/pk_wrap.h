...
typedef struct  {
	...
	unsigned char *ed_pri_key;
	unsigned char *mldsa_pub_key;
	unsigned char *mldsa_pri_key;
...
} mbedtls_ed25519_mlds65_ctx;


extern const mbedtls_pk_info_t mbedtls_ed25519_mlds44_info;
typedef struct  {
	unsigned char *ed_pub_key;
	unsigned char *ed_pri_key;
	unsigned char *mldsa_pub_key;
	...
	unsigned int ed_pubsize;
	unsigned int ed_prisize;
	unsigned int mldsa_pubsize;
	unsigned int mldsa_prisize;

} mbedtls_ed25519_mlds44_ctx;
