...
BEGIN {
    ...
    require '/home/secpat/Desktop/QUBIP/qubip_csic_mbedtls/openssl/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/secpat/Desktop/QUBIP/qubip_csic_mbedtls/openssl/test/fips-and-base.cnf';
    shift;
